...
import { SanityTour, SanityDestination, SanityStory } from "./types";
...
export function mapSanityStoryToAppStory(raw: SanityStory): Story {
  return {
    ...
    excerpt: raw.excerpt || "",
    author: raw.author || "Sonali Sharma",
    authorRole: raw.authorRole || "Founder & Lead Explorer",
    authorAvatar: resolveImageUrl(raw.authorAvatar, "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=300&q=80"),
    date: raw.date || "2026",
