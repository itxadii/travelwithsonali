...
export default function DestinationDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#FDF7F4] text-[#685752] flex flex-col font-sans">
      ...
      <section className="w-full py-16 bg-[#F7EFEA] border-t border-[#E8DCD5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12">
            ...
            <Link
              href="/tours"
              className="mt-4 sm:mt-0 text-sm font-semibold text-[#8EB486] hover:underline"
            >
              View All Tours →
            </Link>
          </div>
      ...
      {relatedDestinations.length > 0 && (
        <section className="w-full py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-[#E8DCD5]">
