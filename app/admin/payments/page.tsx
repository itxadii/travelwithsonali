  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="p-3.5 rounded-2xl bg-white border border-[#EBE5DF] shadow-xs flex items-center gap-4 text-xs">
          <span className="text-[#7A746E] uppercase font-semibold">Total Collected</span>
      ...
      <div className="p-6 rounded-3xl bg-white border border-[#EBE5DF] shadow-xs">
        {loading ? (
          ...
          <div className="py-16 text-center text-sm text-[#7A746E]">No payment records found.</div>
        ) : (
              ...
              <tbody className="divide-y divide-[#EBE5DF]">
                {filtered.map((p) => (
                  <tr key={p.id} className="hover:bg-[#FAF6F0] transition-colors">
                    <td className="py-3.5 font-bold text-[#1C1917]">{p.id}</td>
                    <td className="py-3.5 text-[#E05328] font-semibold">{p.bookingId}</td>
                    ...
                    <td className="py-3.5 text-[#7A746E]">{p.paymentDate}</td>
